...
def setup(self):
    ...
    #Q- Network
    self.qnetwork_local = QNetwork(4, len(ACTIONS)).to(device)
...
def act(self, game_state: dict) -> str:
    ...
    self.qnetwork_local.eval()
    with torch.no_grad():
        action_values = self.qnetwork_local(features)
    #print(action_values)
